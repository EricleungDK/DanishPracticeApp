    ...
    <div className="w-full max-w-3xl mx-auto">
      <div className="flex items-center mb-3">
        <button
          ...
          aria-label="Pause review and return to dashboard"
        >
          <ArrowLeft size={16} />
      ...
      <ExerciseCard exercise={exercise} index={currentIndex} total={sessionExercises.length}>
        ...
        {lastResult && awaitingRating && (
          <ResultDisplay correct={lastResult.correct} expected={lastResult.expected} explanation={lastResult.explanation} onRate={rateAndNext} />
        )}
      </ExerciseCard>
    </div>
  );
